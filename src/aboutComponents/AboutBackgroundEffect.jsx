...
export default function AboutBackgroundEffect({
  mouseForce = 20,
  cursorSize = 80,
  isViscous = false,
  viscous = 30,
...
`;
  ...
  return <Box ref={mountRef} className={`liquid-ether-container ${className || ''}`} style={style} />;
}
